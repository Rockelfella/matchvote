...
@admin_router.patch("/{scene_id}/release", status_code=status.HTTP_200_OK)
...
@admin_router.patch("/{scene_id}/unrelease", status_code=status.HTTP_200_OK)
...
@admin_router.delete("/{scene_id}", status_code=status.HTTP_204_NO_CONTENT)
